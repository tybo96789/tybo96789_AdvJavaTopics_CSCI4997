...
/**
 * This is week 1 stuff for CSCI 4997
 * @author Tyler Atiburcio
 * @version 0.2
 */
public class AtiburcioTyler_Week1
{

    public static void main (String args[])
    {
      System.err.println("This is just a template class! It has no standalone running features!\nTerminating!");
    }
    ...
    */
    public static class GUITemplate extends JFrame
    {
